...
//    JSONArray jsonArray3 = (JSONArray) jsonArray2.get(0);
    ...
    public static void translateText(String inFile, String outFile, String src, String dst) {
        String base = "/Users/guxu/Documents/idea_proj/JavaSenior/dataStructure/src/com/guxu/other/";
        File file1 = new File(base+  inFile);
        File file2 = new File(base + outFile);
        try {
            ...
            while((lineTxt = bufferedReader.readLine()) != null) {
                if ((i - 2) % 4 == 0) {
                    String out = translate(src, dst, lineTxt);
    ...
    public static void translateTextWithOrigin(String inFile, String outFile, String src, String dst) {
        String base = "/Users/guxu/Documents/idea_proj/JavaSenior/dataStructure/src/com/guxu/other/";
        File file1 = new File(base+  inFile);
        File file2 = new File(base + outFile);
        try {
    ...
    public static void main(String[] args) throws Exception {
        translateTextWithOrigin("7月28日.srt",
                "7月28日_trans.srt",
                "en",
                "zh-CN");
    }
